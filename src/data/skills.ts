...
export const skills: SkillCategory[] = [
	{
		...
		items: [
			...
			{ name: 'Vue.js', icon: 'vue', url: 'https://vuejs.org/guide/introduction.html' },
			{ name: 'Nuxt.js', icon: 'nuxtjs', url: 'https://nuxt.com/docs' },
			{ name: 'Java', icon: 'java', url: 'https://docs.oracle.com/en/java/' },
			{ name: 'Spring Boot', icon: 'spring', url: 'https://spring.io/projects/spring-boot' },
		]
	},
	{
		...
		items: [
			...
			{ name: 'Kubernetes', icon: 'kubernetes', url: 'https://kubernetes.io/docs/home/' },
			{ name: 'Redis', icon: 'redis', url: 'https://redis.io/docs/latest/' },
			{ name: 'Trino', icon: 'postgres', url: 'https://trino.io/docs/current/' },
		]
	},
	{
		category: 'Basic',
